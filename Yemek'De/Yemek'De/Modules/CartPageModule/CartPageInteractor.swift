...
class CartPageInteractor: PresenterToInteractorCartPageProtocol {
    ...
    func changeCartFoodCountI(yemek_adi: String, yemek_resim_adi: String, yemek_fiyat: String, sepet_yemek_id: String, yeniAdet: String) {
        ...
        let veri: Parameters = ["sepet_yemek_id": sepet_yemek_id, "kullanici_adi": "dYesiloglu"]
        
        
        AF.request("http://kasimadalan.pe.hu/yemekler/sepettenYemekSil.php", method: .post, parameters: veri).response { response in
